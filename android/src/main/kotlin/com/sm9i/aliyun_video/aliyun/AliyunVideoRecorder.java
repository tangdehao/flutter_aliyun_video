...
//        setContentView(R.layout.alivc_recorder_activity_video_recorder);
//        getStyleParam();
...
////                crop = Class.forName("com.aliyun.svideo.media.MediaActivity");
//            } catch (ClassNotFoundException e) {
//                e.printStackTrace();
//            }
//            if (crop == null) {
...
//            Toast.makeText(this, R.string.alivc_music_no_free_memory, Toast.LENGTH_SHORT).show();
//            return false;
//        }
//        return true;
//    }
...
//            name = getString(R.string.alivc_recorder_record_filter_null);
//        }
...
//        if (v == mRecordBtn) {
//            if (isOpenFailed) {
//                Toast.makeText(this, R.string.alivc_recorder_record_camera_permission_tip, Toast.LENGTH_SHORT).show();
//                return true;
//            }
