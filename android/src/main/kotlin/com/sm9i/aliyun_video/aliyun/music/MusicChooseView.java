package com.sm9i.aliyun_video.aliyun.music;
...
import com.sm9i.aliyun_video.aliyun.base.CopyrightWebActivity;
import com.sm9i.aliyun_video.aliyun.base.utils.MD5Utils;
import com.sm9i.aliyun_video.aliyun.base.utils.UriUtils;
import com.sm9i.aliyun_video.aliyun.download.zipprocessor.FileDownloaderCallback;
import com.sm9i.aliyun_video.aliyun.view.effects.EffectBody;
    ...
    public void onClick(View v) {
        if (v == mAliyunBackBtn) {
            ...
            if (musicSelectListener != null) {
                ...
                if (Build.VERSION.SDK_INT >= 29&& !TextUtils.isEmpty(mSelectMusic.uri)) {
